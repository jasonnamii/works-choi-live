...
MICROINTERACTION: source-pass / heart-only-1.3s / peak-5x / overflow-visible / reduced-motion-safe
...
- [x] GNB 가장 오른쪽 `회사소개`와 FAQ 다음 `#about`, 백선미 이사·두 번째 멤버 더미 연결 — 소스 확인
- [x] 회사소개 자산 응답 200, 알파 경계·초록 잔류 0, 데스크톱 2열·모바일 1열 — 최종 렌더 확인
...
- 카탈로그는 운영 상품 100개를 모두 표시하고 추천은 같은 100개 안에서 기존 적격 조건 유지
...
- 최종 렌더 캡처 14장: `Temp/3picks-qa-260811/page-layout/`; 5개 뷰포트 전체 화면과 히어로·회사소개 표적 캡처 보존
...
- `node tools/test_recommendation.js` — 운영 100개 경계, 행사·수량·예산 96개 조합, 10만 원 회귀, 예산 모름, 공직자 5만 원 검사 통과
- 브라우저 — 1440·1280·768·390·375px 가로 넘침 0·콘솔 오류 0, 회사소개 2열/1열, 375·390px 히어로 이미지 우선·비잘림 확인
