...
assert.equal((html.match(/<a href="#about">Our brand story<\/a>/g) || []).length, 1, "GNB의 Our brand story 라벨이 없거나 중복됐습니다.");
assert.equal((html.match(/<a href="#about">멤버 소개<\/a>/g) || []).length, 1, "푸터의 멤버 소개 라벨이 없거나 중복됐습니다.");
