...
const checks = [
  ...
  [html.includes("--tp-shadow-overlay:8px 8px 0 var(--tp-ink)") && html.includes(".quote-float.is-open{box-shadow:var(--tp-shadow-overlay)}"), "quote palette uses a hard offset black-paper layer without blur"],
