...
const checks = [
  ...
  [html.includes("padding:12px;background:#FFFFFF;scroll-snap-align:start") && html.includes("border-right:1px solid var(--tp-line);background:#FFFFFF"), "populated quote products and summary keep white surfaces"],
