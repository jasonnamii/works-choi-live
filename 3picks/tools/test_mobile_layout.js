...
const checks = [
  ...
  [html.includes("--tp-shadow-overlay:5px 5px 0 var(--tp-ink)") && html.includes(".quote-float.is-open{box-shadow:var(--tp-shadow-overlay)}"), "quote palette uses a reduced hard offset black-paper layer without blur"],
