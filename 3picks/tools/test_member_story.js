...
assert.ok(html.includes(".about__content{display:grid;grid-template-columns:minmax(0,5fr) minmax(520px,7fr)"), "데스크톱 카피 5 : 인물 7의 좌우 전환 구조가 없습니다.");
