...
assert.ok(html.includes("7,300여 개 리서치 데이터에서 66대 1의 경쟁률을 뚫고 선정된 110개 굿즈입니다"), "Accessible curation summary missing");
assert.ok(html.includes("<strong>7,300+</strong>개 리서치 데이터에서 고른"), "Research data copy missing");
assert.ok(html.includes("<h2><mark>66대 1</mark>의 경쟁률을 뚫은<br>110개의 굿즈만 보여드려요</h2>"), "Copy-led curation headline missing");
